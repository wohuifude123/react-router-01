...
export const Foundation = (WrappedComponent) => {
    ...
    class NewComponent extends WrappedComponent {
        ...
        _init() {
            // 参数设置
            var doc = document.getElementsByClassName(this.state.className)[0];
            /*
            var optionECharts = {
                title: {
                    text: 'ECharts 入门测试开始'
        ...
        */
        ...
        render() {
            ...
            */
            ...
            for(var stateStyle in this.state.style)
            {
                //console.log(stateStyle);
                //console.log(this.state.style[stateStyle]);
                divECharts[stateStyle] = this.state.style[stateStyle];
            }


            return (
                <div>
                    <div className={this.state.className} style={divECharts}></div>
